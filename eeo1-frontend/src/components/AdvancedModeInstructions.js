const AdvancedModeInstructions = () => {
    return <p className='small-text'>Instructions for advanced mode:
    <ul>
    <li>Advanced mode allows you to pick multiple job titles to view by either gender or race. </li>
    <li>The order the stacked pie chart will display is outwards in, from the top selection to the final selection. </li>
    <li>If you select all years, you will only be able to see one job functional group.</li>
