...
const AdvancedSort1DD = ({jobs,setParams}) => {
    ...
    console.log(jobList)
    return (<span><Multiselect options={jobOptions} selectedValues={jobList} onSelect={(e)=>{addJob(e,this)}} onRemove={(e)=>{removeJob(e)}} showCheckbox='true' showArrow='true' isObject='true' displayValue='key'/></span>);
    };
